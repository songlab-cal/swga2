...
parser.add_option('-p', '--max_primer', default=500, type=int, help='')
...
parser.add_option('-r', '--max_dimer_bp', default=3, type=int, help='')
parser.add_option('-q', '--max_self_dimer_bp', default=4, type=int, help='')
parser.add_option('--selection_metric', default='deterministic', type=str, help='')
parser.add_option('-i', '--iterations', default=10, type=int, help='')
parser.add_option('-w', '--max_sets', default=5, type=int, help='')
parser.add_option('-f', '--fg_circular', action="store_true", help='')
parser.add_option('-b', '--bg_circular', action="store_false", help='')
