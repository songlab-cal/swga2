...
def is_dimer(seq_1, seq_2, max_dimer_bp=src.parameter.max_dimer_bp):
...
def heterodimer_matrix(primer_list, max_dimer_bp=src.parameter.max_dimer_bp, het_type='boolean'):
...
def is_compatible_set(primer_set, max_dimer_bp=src.parameter.max_dimer_bp):
